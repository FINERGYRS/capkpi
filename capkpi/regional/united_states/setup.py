...
def setup(company=None, patch=True):
	...
	if finergy.db.count("Company", {"country": "United States"}) <= 1:
...
def add_print_formats():
	finergy.reload_doc("regional", "print_format", "irs_1099_form")
	finergy.db.set_value("Print Format", "IRS 1099 Form", "disabled", 0)
