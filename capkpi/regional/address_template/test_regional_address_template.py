...
from capkpi.regional.address_template.setup import get_address_templates, update_address_template


def ensure_country(country):
	if finergy.db.exists("Country", country):
		return finergy.get_doc("Country", country)
	else:
		c = finergy.get_doc({"doctype": "Country", "country_name": country})
		c.insert()
		return c
