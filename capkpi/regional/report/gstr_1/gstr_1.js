...
finergy.query_reports["GSTR-1"] = {
	...
	onload: function (report) {
		...
		finergy.call({
			method: 'capkpi.regional.report.gstr_1.gstr_1.get_company_gstins',
			args: {
				company: filters.company
			},
			callback: function(r) {
				finergy.query_report.page.fields_dict.company_gstin.df.options = r.message;
				finergy.query_report.page.fields_dict.company_gstin.refresh();
			}
		});
		...
		report.page.add_inner_button(__("Download as JSON"), function () {
			...
			finergy.call({
				method: 'capkpi.regional.report.gstr_1.gstr_1.get_json',
				args: {
					data: report.data,
				...
				callback: function(r) {
					if (r.message) {
						const args = {
							cmd: 'capkpi.regional.report.gstr_1.gstr_1.download_json_file',
							data: r.message.data,
