import finergy
from finergy.utils import get_time, getdate, today

from capkpi.accounts.utils import update_gl_entries_after
from capkpi.stock.stock_ledger import update_entries_after
...
def execute():
	...
	finergy.clear_cache()
	finergy.flags.warehouse_account_map = {}
	...
	if data:
		for row in finergy.get_all("Company", filters={"enable_perpetual_inventory": 1}):
