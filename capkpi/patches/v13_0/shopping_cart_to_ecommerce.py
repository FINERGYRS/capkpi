...
def execute():
	...
	finergy.delete_doc("DocType", "Shopping Cart Settings", ignore_missing=True)
	finergy.delete_doc("DocType", "Products Settings", ignore_missing=True)
	finergy.delete_doc("DocType", "Supplier Item Group", ignore_missing=True)

	if finergy.db.get_single_value("E Commerce Settings", "enabled"):
		notify_users()
