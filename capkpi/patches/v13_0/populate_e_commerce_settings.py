...
def execute():
	...
	finergy.reload_doc("portal", "doctype", "website_filter_field")
	finergy.reload_doc("portal", "doctype", "website_attribute")
	...
	def map_into_e_commerce_settings(doctype, fields):
		singles = finergy.qb.DocType("Singles")
		query = (
			finergy.qb.from_(singles)
