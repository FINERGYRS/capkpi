...
def execute():
	...
	"""
	finergy.reload_doc("manufacturing", "doctype", "production_plan_item")

	work_order = finergy.qb.DocType("Work Order")
	pp_item = finergy.qb.DocType("Production Plan Item")

	broken_work_orders = (
		finergy.qb.from_(work_order)
		.left_join(pp_item)
