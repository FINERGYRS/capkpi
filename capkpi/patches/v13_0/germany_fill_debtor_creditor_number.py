...
def execute():
	...
	for company in company_list:
		party_account_list = finergy.get_all(
			"Party Account",
		...
		for party_account in party_account_list:
			...
			account_number = finergy.db.get_value("Account", party_account.account, "account_number")
			...
			finergy.db.set_value("Party Account", party_account.name, "account", "")
