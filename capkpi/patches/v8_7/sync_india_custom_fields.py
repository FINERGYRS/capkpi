...
def execute():
	...
	finergy.reload_doc("Payroll", "doctype", "payroll_period")
	finergy.reload_doc("Payroll", "doctype", "employee_tax_exemption_declaration")
	finergy.reload_doc("Payroll", "doctype", "employee_tax_exemption_proof_submission")
	finergy.reload_doc("Payroll", "doctype", "employee_tax_exemption_declaration_category")
	finergy.reload_doc("Payroll", "doctype", "employee_tax_exemption_proof_submission_detail")
