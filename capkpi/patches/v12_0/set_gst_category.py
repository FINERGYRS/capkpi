...
def execute():
	...
	finergy.reload_doc("accounts", "doctype", "Tax Category")

	make_custom_fields()

	for doctype in ["Sales Invoice", "Purchase Invoice"]:
		has_column = finergy.db.has_column(doctype, "invoice_type")
	...
	finergy.delete_doc("Custom Field", "Sales Invoice-invoice_type")
	finergy.delete_doc("Custom Field", "Purchase Invoice-invoice_type")
	...
	has_gst_fields = finergy.db.has_column("Purchase Invoice", "eligibility_for_itc")
