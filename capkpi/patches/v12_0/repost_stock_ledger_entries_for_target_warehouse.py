...
def execute():
	warehouse_perm = finergy.get_all(
		"User Permission",
	...
	for doctype in ["Sales Invoice", "Delivery Note"]:
		if not finergy.get_meta(doctype + " Item").get_field("target_warehouse").hidden:
			continue
	...
	if finergy.get_meta("Sales Order Item").get_field("target_warehouse").hidden:
		finergy.db.sql(
