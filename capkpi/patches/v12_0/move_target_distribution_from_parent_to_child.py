...
def execute():
	finergy.reload_doc("setup", "doctype", "target_detail")
	...
	finergy.delete_doc("Report", "Sales Partner-wise Transaction Summary")
	finergy.delete_doc("Report", "Sales Person Target Variance Item Group-Wise")
	finergy.delete_doc("Report", "Territory Target Variance Item Group-Wise")
