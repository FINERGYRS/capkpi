...
def execute():
	...
	if not finergy.get_meta("Journal Entry Account").has_field("bank_account"):
		finergy.reload_doc("Accounts", "doctype", "Journal Entry Account")
...
def update_journal_entry_account_fieldname():
	...
	if finergy.db.has_column("Journal Entry Account", "bank_account_no"):
