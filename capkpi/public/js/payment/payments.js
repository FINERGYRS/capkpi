...
capkpi.payments = class payments extends capkpi.stock.StockController {
	make_payment() {
		var me = this;
	...
	make_keyboard(){
		var me = this;
		$(this.$body).empty();
		$(this.$body).html(finergy.render_template('pos_payment', this.frm.doc))
	...
	make_multimode_payment(){
		...
		this.payments = finergy.model.add_child(this.frm.doc, 'Multi Mode Payment', "payments");
	...
	show_payment_details(){
		...
		if (this.frm.doc.payments.length) {
			$.each(this.frm.doc.payments, function(index, data) {
				$(finergy.render_template('payment_details', {
	...
	show_amounts(){
		...
		$(this.$body).find('.outstanding_amount').text(format_currency(this.frm.doc.outstanding_amount, finergy.get_doc(":Company", this.frm.doc.company).default_currency));
		this.update_invoice();
	}
}
