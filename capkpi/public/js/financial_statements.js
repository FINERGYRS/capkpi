finergy.provide("capkpi.financial_statements");
...
capkpi.financial_statements = {
	...
	"open_general_ledger": function(data) {
		...
		var project = $.grep(finergy.query_report.filters, function(e){ return e.df.fieldname == 'project'; })
	...
	onload: function(report) {
		...
		capkpi.financial_statements.filters = get_filters()
		...
		report.page.add_custom_menu_item(views_menu, __("Balance Sheet"), function() {
			...
			finergy.set_route('query-report', 'Balance Sheet', {company: filters.company});
		});

		report.page.add_custom_menu_item(views_menu, __("Profit and Loss"), function() {
			var filters = report.get_values();
			finergy.set_route('query-report', 'Profit and Loss Statement', {company: filters.company});
		});

		report.page.add_custom_menu_item(views_menu, __("Cash Flow Statement"), function() {
			var filters = report.get_values();
			finergy.set_route('query-report', 'Cash Flow', {company: filters.company});
		});
	}
};
