...
capkpi.StockGridReport = class StockGridReport extends finergy.views.TreeGridReport {
	...
	get_serialized_buying_rates() {
		...
		if (finergy.report_dump.data["Serial No"]) {
			$.each(finergy.report_dump.data["Serial No"], function(i, sn) {
