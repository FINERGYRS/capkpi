...
from finergy.utils import get_timespan_date_range, getdate


@finergy.whitelist()
def get_therapy_sessions_count(patient):
	total = finergy.db.count("Therapy Session", filters={"docstatus": 1, "patient": patient})

	month_start = datetime.today().replace(day=1)
	this_month = finergy.db.count(
