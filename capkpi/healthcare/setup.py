...
from capkpi.setup.utils import insert_record


def setup_healthcare():
	if finergy.db.exists("Medical Department", "Cardiology"):
		# already setup
		return
...
def create_medical_departments():
	...
	for department in departments:
		mediacal_department = finergy.new_doc("Medical Department")
...
def create_antibiotics():
	...
	for a in abt:
		antibiotic = finergy.new_doc("Antibiotic")
...
def get_company():
	...
	if company:
		...
		company = finergy.get_list("Company", limit=1)
		if company:
