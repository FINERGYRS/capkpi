...
finergy.ui.form.on('Therapy Plan', {
	setup: function(frm) {
			...
			if (frm.doc.status != 'Completed') {
				...
				frm.add_custom_button(__('Therapy Session'), function() {
					finergy.prompt(fields, data => {
						finergy.call({
							method: 'capkpi.healthcare.doctype.therapy_plan.therapy_plan.make_therapy_session',
							args: {
	...
	make_sales_invoice: function(frm) {
		finergy.call({
			...
			method: 'capkpi.healthcare.doctype.therapy_plan.therapy_plan.make_sales_invoice',
			callback: function(r) {
...
finergy.ui.form.on('Therapy Plan Detail', {
