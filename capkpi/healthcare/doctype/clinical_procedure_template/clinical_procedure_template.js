...
finergy.ui.form.on('Clinical Procedure Template', {
...
let change_template_code = function(doc) {
	let d = new finergy.ui.Dialog({
		...
		primary_action: function() {
			...
			if (values) {
				finergy.call({
					'method': 'capkpi.healthcare.doctype.clinical_procedure_template.clinical_procedure_template.change_item_code_from_template',
...
finergy.tour['Clinical Procedure Template'] = [
	{
		fieldname: 'template',
