...
test_records = finergy.get_test_records("Currency Exchange")
...
def save_new_records(test_records):
	for record in test_records:
		...
		try:
			finergy.set_value(**kwargs)
		except finergy.DoesNotExistError:
			curr_exchange = finergy.new_doc(record.get("doctype"))
...
class TestCurrencyExchange(unittest.TestCase):
	...
	def tearDown(self):
		finergy.db.set_value("Accounts Settings", None, "allow_stale", 1)
		self.clear_cache()
	...
	def test_exchange_rate_via_exchangerate_host(self, mock_get):
		...
		settings = finergy.get_single("Currency Exchange Settings")
	...
	def test_exchange_rate_strict(self, mock_get):
		...
		finergy.db.set_value("Accounts Settings", None, "allow_stale", 0)
		finergy.db.set_value("Accounts Settings", None, "stale_days", 1)
