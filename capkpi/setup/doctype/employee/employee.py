...
from finergy.utils import cstr, getdate, today, validate_email_address
...
class Employee(NestedSet):
	...
	def validate_duplicate_user_id(self):
		Employee = finergy.qb.DocType("Employee")
		employee = (
			finergy.qb.from_(Employee)
...
def get_holiday_list_for_employee(employee, raise_exception=True):
	if employee:
		holiday_list, company = finergy.db.get_value("Employee", employee, ["holiday_list", "company"])
	else:
		holiday_list = ""
