...
def create_email_digest():
	...
	companies = finergy.db.sql_list("select name FROM `tabCompany`")
	for company in companies:
		if not finergy.db.exists("Email Digest", "Default Weekly Digest - " + company):
			edigest = finergy.get_doc(
				{
	...
	if companies:
		edigest = finergy.new_doc("Email Digest")
		edigest.update(
			{
