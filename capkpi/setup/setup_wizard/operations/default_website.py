...
class website_maker(object):
	...
	def make_web_page(self):
		# home page
		homepage = finergy.get_doc("Homepage", "Homepage")
	...
	def make_blog(self):
		...
		blogger = finergy.new_doc("Blogger")
		...
		finergy.get_doc(
			{
				...
				"content": finergy.get_template("setup/setup_wizard/data/sample_blog_post.html").render(),
			}
		).insert()


def test():
	finergy.delete_doc("Web Page", "test-company")
	finergy.delete_doc("Blog Post", "welcome")
	finergy.delete_doc("Blogger", "administrator")
	finergy.delete_doc("Blog Category", "general")
	website_maker(
		{
