...
class TestSubcontractingReceipt(FinergyTestCase):
	def setUp(self):
		make_subcontracted_items()
		make_raw_materials()
		make_service_items()
	...
	def test_subcontracting_over_receipt(self):
		...
		"""
		from capkpi.controllers.subcontracting_controller import (
			make_rm_stock_entry as make_subcontract_transfer_entry,
		)
		from capkpi.subcontracting.doctype.subcontracting_order.subcontracting_order import (
			make_subcontracting_receipt,
		)
		from capkpi.subcontracting.doctype.subcontracting_order.test_subcontracting_order import (
			make_subcontracted_item,
		)
		...
		ste = finergy.get_doc(make_subcontract_transfer_entry(sco.name, rm_items))
		...
		scr1.submit()
		self.assertRaises(finergy.ValidationError, scr2.submit)
	...
	def test_subcontracting_order_over_return(self):
		...
		from capkpi.controllers.status_updater import OverAllowanceError

		args = finergy._dict(scr_name=scr1.name, qty=-15)
