...
finergy.ui.form.on('Subcontracting Order', {
	setup: (frm) => {
...
capkpi.buying.SubcontractingOrderController = class SubcontractingOrderController {
	setup() {
	...
	make_subcontracting_receipt() {
		finergy.model.open_mapped_doc({
			method: 'capkpi.subcontracting.doctype.subcontracting_order.subcontracting_order.make_subcontracting_receipt',
			frm: cur_frm,
...
extend_cscript(cur_frm.cscript, new capkpi.buying.SubcontractingOrderController({ frm: cur_frm }));