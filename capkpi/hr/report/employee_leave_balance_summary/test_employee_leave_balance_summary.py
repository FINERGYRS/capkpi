...
import finergy
from finergy.utils import add_days, flt, get_year_ending, get_year_start, getdate
...
from capkpi.hr.report.employee_leave_balance_summary.employee_leave_balance_summary import execute
	...
	def test_employee_leave_balance_summary(self):
		...
		expected_data = [
			[
				...
				finergy.db.get_value("Employee", self.employee_id, "department"),
				flt(
