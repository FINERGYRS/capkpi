...
import finergy
from finergy.utils import add_days, add_months, flt, get_year_ending, get_year_start, getdate
...
from capkpi.hr.report.employee_leave_balance.employee_leave_balance import execute
...
class TestEmployeeLeaveBalance(unittest.TestCase):
	...
	def test_employee_leave_balance(self):
		finergy.get_doc(test_records[0]).insert()
	...
	def test_employee_status_filter(self):
		...
		finergy.db.set_value("Employee", inactive_emp, "status", "Inactive")
