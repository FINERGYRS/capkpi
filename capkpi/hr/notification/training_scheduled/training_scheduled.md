        ...
        <td>
            <div>
                ...
                <ul class="list-unstyled" style="line-height: 1.7">
                    ...
                    {% set start = finergy.utils.get_datetime(doc.start_time) %}
                    {% set end = finergy.utils.get_datetime(doc.end_time) %}
                    ...
                    {% endif %}
                    <li>{{ _("Event Link") }}: {{ finergy.utils.get_link_to_form(doc.doctype, doc.name) }}</li>
                    {% if doc.is_mandatory %}
