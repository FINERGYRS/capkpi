...
capkpi.hr.EmployeeController = finergy.ui.form.Controller.extend({
	setup: function() {
...
finergy.ui.form.on('Employee', {
	...
	create_user: function(frm) {
		...
		finergy.call({
			method: "capkpi.hr.doctype.employee.employee.create_user",
			args: {
...
cur_frm.cscript = new capkpi.hr.EmployeeController({
	frm: cur_frm
});
