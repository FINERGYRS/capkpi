...
def create_employee_grievance():
	...
	grievance = finergy.new_doc("Employee Grievance")
...
def create_grievance_type():
	if finergy.db.exists("Grievance Type", "Employee Abuse"):
		return finergy.get_doc("Grievance Type", "Employee Abuse")
	grievance_type = finergy.new_doc("Grievance Type")
