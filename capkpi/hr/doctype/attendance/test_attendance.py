...
from capkpi.hr.doctype.attendance.attendance import (
	get_month_map,
	get_unmarked_days,
	mark_attendance,
)
...
test_records = finergy.get_test_records("Attendance")


class TestAttendance(FinergyTestCase):
	def setUp(self):
	...
	def test_mark_absent(self):
		...
		date = nowdate()
		finergy.db.delete("Attendance", {"employee": employee, "attendance_date": date})
		attendance = mark_attendance(employee, date, "Absent")
		fetch_attendance = finergy.get_value(
	...
	def test_unmarked_days(self):
		...
		finergy.db.delete("Attendance", {"employee": employee})
		finergy.db.set_value("Employee", employee, "holiday_list", self.holiday_list)
