...
from capkpi.hr.doctype.employee_advance.employee_advance import (
	EmployeeAdvanceOverPayment,
	create_return_through_additional_salary,
	make_bank_entry,
	make_return_entry,
)
from capkpi.hr.doctype.expense_claim.expense_claim import get_advances
from capkpi.hr.doctype.expense_claim.test_expense_claim import (
	get_payable_account,
	make_expense_claim,
)
from capkpi.payroll.doctype.salary_component.test_salary_component import create_salary_component
...
def make_payment_entry(advance):
	journal_entry = finergy.get_doc(make_bank_entry("Employee Advance", advance.name))
...
def make_employee_advance(employee_name, args=None):
	doc = finergy.new_doc("Employee Advance")
	doc.employee = employee_name
	doc.company = "_Test company"
	doc.purpose = "For site visit"
	doc.currency = capkpi.get_company_currency("_Test company")
	doc.exchange_rate = 1
