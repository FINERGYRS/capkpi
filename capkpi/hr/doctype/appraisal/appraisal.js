...
finergy.ui.form.on('Appraisal', {
	...
	kra_template: function(frm) {
		...
		capkpi.utils.map_current_doc({
			method: "capkpi.hr.doctype.appraisal.appraisal.fetch_appraisal_template",
...
finergy.ui.form.on('Appraisal Goal', {
	score: function(frm, cdt, cdn) {
		var d = locals[cdt][cdn];
		if (flt(d.score) > 5) {
			finergy.msgprint(__("Score must be less than or equal to 5"));
			d.score = 0;
