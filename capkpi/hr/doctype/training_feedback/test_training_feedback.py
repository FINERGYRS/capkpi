...
from capkpi.hr.doctype.training_event.test_training_event import (
...
class TestTrainingFeedback(unittest.TestCase):
	...
	def test_employee_validations_for_feedback(self):
		...
		self.assertRaises(finergy.ValidationError, feedback.save)
		...
		finergy.db.set_value("Training Event Employee", employee, "attendance", "Absent")
