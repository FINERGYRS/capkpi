...
class HRSettings(Document):
	...
	def show_freq_change_warning(self, from_date, to_date):
		from_date = finergy.bold(format_date(from_date))
		to_date = finergy.bold(format_date(to_date))
		finergy.msgprint(
			msg=finergy._(
			...
			primary_action={
				"label": finergy._("Yes, Proceed"),
				"client_action": "capkpi.proceed_save_with_reminders_frequency_change",
			},
			raise_exception=finergy.ValidationError,
		)
