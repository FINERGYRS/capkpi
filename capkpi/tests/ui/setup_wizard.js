...
const finergy_ui_tests_path = path_join(apps_path, 'finergy', 'finergy', 'tests', 'ui');

const login = require(finergy_ui_tests_path + "/login.js")['Login'];
const welcome = require(finergy_ui_tests_path + "/setup_wizard.js")['Welcome'];
const region = require(finergy_ui_tests_path + "/setup_wizard.js")['Region'];
const user = require(finergy_ui_tests_path + "/setup_wizard.js")['User'];
