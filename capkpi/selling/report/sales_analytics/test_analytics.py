...
from capkpi.selling.report.sales_analytics.sales_analytics import execute


class TestAnalytics(FinergyTestCase):
	def test_sales_analytics(self):
		finergy.db.sql("delete from `tabSales Order` where company='_Test Company 2'")
