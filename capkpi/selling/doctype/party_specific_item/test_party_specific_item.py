...
class TestPartySpecificItem(FinergyTestCase):
	def setUp(self):
		self.customer = finergy.get_last_doc("Customer")
		self.supplier = finergy.get_last_doc("Supplier")
		self.item = finergy.get_last_doc("Item")
