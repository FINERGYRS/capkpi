finergy.listview_settings['Quotation'] = {
	...
	onload: function(listview) {
		...
		listview.page.add_action_item(__("Sales Order"), ()=>{
			capkpi.bulk_transaction_processing.create(listview, "Quotation", "Sales Order");
		});

		listview.page.add_action_item(__("Sales Invoice"), ()=>{
			capkpi.bulk_transaction_processing.create(listview, "Quotation", "Sales Invoice");
		});
	},
