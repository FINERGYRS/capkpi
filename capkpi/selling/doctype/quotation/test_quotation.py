...
from finergy.utils import add_days, add_months, flt, getdate, nowdate

test_dependencies = ["Product Bundle"]


class TestQuotation(FinergyTestCase):
	...
	def test_make_sales_order_terms_copied(self):
		from capkpi.selling.doctype.quotation.quotation import make_sales_order

		quotation = finergy.copy_doc(test_records[0])
	...
	def test_make_sales_order(self):
		...
		self.assertRaises(finergy.ValidationError, make_sales_order, quotation.name)
		quotation.submit()
	...
	def test_valid_till(self):
		...
		self.assertRaises(finergy.ValidationError, quotation.validate)
	...
	def test_shopping_cart_without_website_item(self):
		if finergy.db.exists("Website Item", {"item_code": "_Test Item Home Desktop 100"}):
			finergy.get_last_doc("Website Item", {"item_code": "_Test Item Home Desktop 100"}).delete()
	...
	def test_quotation_expiry(self):
		from capkpi.selling.doctype.quotation.quotation import set_expired_status
...
test_records = finergy.get_test_records("Quotation")
