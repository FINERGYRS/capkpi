...
from capkpi.manufacturing.doctype.routing.test_routing import create_routing, setup_bom
from capkpi.manufacturing.doctype.workstation.workstation import (
...
test_records = finergy.get_test_records("Workstation")
make_test_records("Workstation")


class TestWorkstation(FinergyTestCase):
	...
	def test_update_bom_operation_rate(self):
		...
		w1 = finergy.get_doc("Workstation", "_Test Workstation A")
		# resets values
...
def make_workstation(*args, **kwargs):
	...
	if not finergy.db.exists("Workstation", workstation_name):
		doc = finergy.get_doc({"doctype": "Workstation", "workstation_name": workstation_name})
	...
	return finergy.get_doc("Workstation", workstation_name)
