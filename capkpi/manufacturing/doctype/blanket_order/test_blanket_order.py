...
from finergy.utils import add_months, today
...
class TestBlanketOrder(FinergyTestCase):
	def setUp(self):
		finergy.flags.args = finergy._dict()

	def test_sales_order_creation(self):
		bo = make_blanket_order(blanket_order_type="Selling")

		finergy.flags.args.doctype = "Sales Order"
		...
		bo = finergy.get_doc("Blanket Order", bo.name)
	...
	def test_purchase_order_creation(self):
		...
		finergy.flags.args.doctype = "Purchase Order"
...
def make_blanket_order(**args):
	...
	bo = finergy.new_doc("Blanket Order")
