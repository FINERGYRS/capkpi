...
finergy.ui.form.on('Routing', {
	...
	calculate_operating_cost: function(frm, child) {
		...
		finergy.model.set_value(child.doctype, child.name, "operating_cost", operating_cost);
	}
});

finergy.ui.form.on('BOM Operation', {
