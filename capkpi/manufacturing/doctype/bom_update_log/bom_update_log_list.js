finergy.listview_settings['BOM Update Log'] = {
	add_fields: ["status"],
	get_indicator: (doc) => {
		let status_map = {
			"Queued": "orange",
	...
	onload: () => {
		if (!finergy.model.can_write("Log Settings")) {
			return;
		}
		...
		finergy.require("logtypes.bundle.js", () => {
			finergy.utils.logtypes.show_log_retention_message(cur_list.doctype);
		});
