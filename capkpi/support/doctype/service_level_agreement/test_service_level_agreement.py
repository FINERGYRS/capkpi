...
from capkpi.hr.doctype.employee_group.test_employee_group import make_employee_group
...
def create_service_level_agreement(
	...
	service_level_agreement = finergy.get_doc(
		{
	...
	service_level_agreement_exists = finergy.db.exists("Service Level Agreement", filters)

	if not service_level_agreement_exists:
		service_level_agreement.insert(ignore_permissions=True)
		return service_level_agreement
	else:
		return finergy.get_doc("Service Level Agreement", service_level_agreement_exists)
