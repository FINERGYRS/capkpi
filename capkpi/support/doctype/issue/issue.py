...
from finergy.query_builder import Interval
from finergy.query_builder.functions import Now
from finergy.utils import date_diff, get_datetime, now_datetime, time_diff_in_seconds
...
def set_multiple_status(names, status):
	...
	for name in json.loads(names):
		finergy.db.set_value("Issue", name, "status", status)
...
def auto_close_tickets():
	...
	table = finergy.qb.DocType("Issue")
	issues = (
	...
	for issue in issues:
		doc = finergy.get_doc("Issue", issue)
		doc.status = "Closed"
