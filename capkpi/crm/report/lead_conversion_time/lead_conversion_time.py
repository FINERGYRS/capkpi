...
from finergy.utils import date_diff, flt
...
def get_communication_details(filters):
	...
	communication_list = []
	opportunities = finergy.db.get_values(
		"Opportunity",
	...
	for d in opportunities:
		...
		communication_count = finergy.db.sql(
			"""
				SELECT
					count(*)
				FROM
		...
		support_tickets = len(finergy.db.get_all("Issue", {"raised_by": d.contact_email}))
