...
from capkpi.hotels.doctype.hotel_room_reservation.hotel_room_reservation import (
...
class TestHotelRoomReservation(unittest.TestCase):
	def setUp(self):
		finergy.db.sql("delete from `tabHotel Room Reservation`")
		finergy.db.sql("delete from `tabHotel Room Reservation Item`")
