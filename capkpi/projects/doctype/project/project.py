...
from capkpi.education.doctype.student_attendance.student_attendance import get_holiday_list
from capkpi.hr.doctype.daily_work_summary.daily_work_summary import get_users_email
...
class Project(Document):
	...
	def update_costing(self):
		from_time_sheet = finergy.db.sql(
			"""select
		...
		from_expense_claim = finergy.db.sql(
			"""select
