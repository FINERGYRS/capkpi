...
def get_context(context):
	...
	if homepage.hero_section_based_on == "Homepage Section" and homepage.hero_section:
		homepage.hero_section_doc = finergy.get_doc("Homepage Section", homepage.hero_section)

	if homepage.slideshow:
		doc = finergy.get_doc("Website Slideshow", homepage.slideshow)
	...
	context.homepage_sections = [
		finergy.get_doc("Homepage Section", name) for name in homepage_sections
	]
