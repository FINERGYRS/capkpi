...
def execute(filters=None):
	...
	program_enrollments = finergy.get_list(
		"Program Enrollment",
...
def get_student_details(student_list):
	student_map = finergy._dict()
	student_details = finergy.db.sql(
		"""
...
def get_guardian_map(student_list):
	guardian_map = finergy._dict()
	guardian_details = finergy.db.sql(
		"""
