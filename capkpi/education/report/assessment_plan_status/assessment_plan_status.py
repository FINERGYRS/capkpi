...
def get_assessment_data(args=None):
	...
	assessment_plan = finergy.db.sql(
		"""
			SELECT
	...
	for d in assessment_plan:
		...
		assessment_plan_details = (
			finergy._dict() if not assessment_plan_details else finergy._dict(assessment_plan_details)
		)
...
def get_assessment_result(assessment_plan_list):
	assessment_result_dict = finergy._dict()
