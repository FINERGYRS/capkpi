...
from capkpi.education.api import get_assessment_details, get_grade


class AssessmentResult(Document):
	def validate(self):
		capkpi.education.validate_student_belongs_to_group(self.student, self.student_group)
	...
	def validate_maximum_score(self):
		...
		for d in self.details:
			...
			if d.score > d.maximum_score:
				finergy.throw(_("Score cannot be greater than Maximum Score"))
	...
	def validate_duplicate(self):
		assessment_result = finergy.get_list(
			"Assessment Result",
			filters={
