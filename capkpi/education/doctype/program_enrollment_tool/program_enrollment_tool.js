...
finergy.ui.form.on("Program Enrollment Tool", {
	setup: function(frm) {
	...
	"refresh": function(frm) {
		...
		finergy.realtime.on("program_enrollment_tool", function(data) {
			finergy.hide_msgprint(true);
			finergy.show_progress(__("Enrolling students"), data.progress[0], data.progress[1]);
		});
	},
