// Copyright (c) 2016, Finergy and contributors
// For license information, please see license.txt


finergy.ui.form.on('Program Enrollment', {
	setup: function(frm) {
	...
	onload: function(frm) {
		...
		frm.set_query('student', function() {
			return{
				query: 'capkpi.education.doctype.program_enrollment.program_enrollment.get_students',
				filters: {
					'academic_year': frm.doc.academic_year,
	...
	program: function(frm) {
		...
		if (frm.doc.program) {
			finergy.call({
				method: 'capkpi.education.api.get_fee_schedule',
				args: {
					'program': frm.doc.program,
	...
	student_category: function() {
		finergy.ui.form.trigger('Program Enrollment', 'program');
	},
...
finergy.ui.form.on('Program Enrollment Course', {
