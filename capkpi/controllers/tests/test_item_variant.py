...
from capkpi.controllers.item_variant import copy_attributes_to_variant, make_variant_item_code
from capkpi.stock.doctype.item.test_item import set_item_variant_settings
from capkpi.stock.doctype.quality_inspection.test_quality_inspection import (
...
def make_item_variant():
	finergy.delete_doc_if_exists("Item", "_Test Variant Item-XSL", force=1)
...
def make_quality_inspection_template():
	...
	if finergy.db.exists("Quality Inspection Template", qc_template):
		return qc_template

	qc = finergy.new_doc("Quality Inspection Template")
