...
class TestTaxes(unittest.TestCase):
	def setUp(self):
		...
		self.item_group = finergy.get_doc(
			{
				"doctype": "Item Group",
		...
		self.item_tax_template = finergy.get_doc(
			{
			...
			doc = finergy.get_doc(
				{
					...
					"currency": "USD",
					"schedule_date": finergy.utils.nowdate(),
					"delivery_date": finergy.utils.nowdate(),
