...
from capkpi.controllers.subcontracting_controller import SubcontractingController
		...
		for d in items:
			if not cint(self.get("is_return")):
				...
				if not d.get(finergy.scrub(ref_doctype)):
					...
					rate = finergy.db.get_value(ref_doctype, d.get(finergy.scrub(ref_doctype)), "rate")
