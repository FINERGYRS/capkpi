...
finergy.provide("capkpi_integrations.shopify_settings");

finergy.ui.form.on("Shopify Settings", "onload", function(frm){
	finergy.call({
		method:"capkpi.capkpi_integrations.doctype.shopify_settings.shopify_settings.get_series",
		callback:function(r){
	...
	capkpi_integrations.shopify_settings.setup_queries(frm);
})

finergy.ui.form.on("Shopify Settings", "app_type", function(frm) {
	frm.toggle_reqd("api_key", (frm.doc.app_type == "Private"));
	frm.toggle_reqd("password", (frm.doc.app_type == "Private"));
})

finergy.ui.form.on("Shopify Settings", "refresh", function(frm){
	...
	let app_link = "<a href='https://finergycloud.com/marketplace/apps/ecommerce_integrations' target='_blank'>Ecommerce Integrations</a>"
...
$.extend(capkpi_integrations.shopify_settings, {
