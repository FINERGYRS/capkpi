# Copyright (c) 2020, Finergy Reporting Solutions SAS (Finergy) and contributors
...
def generate_stk_push(**kwargs):
	...
	try:
		...
		finergy.log_error(title=_("Mpesa Express Transaction Error"))
		finergy.throw(
...
def get_account_balance(request_payload):
	...
	try:
		...
		finergy.log_error(title=_("Account Balance Processing Error"))
