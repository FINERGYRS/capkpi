...
# api/method/capkpi.capkpi_integrations.exotel_integration.handle_incoming_call
# api/method/capkpi.capkpi_integrations.exotel_integration.handle_end_call
# api/method/capkpi.capkpi_integrations.exotel_integration.handle_missed_call
...
def handle_incoming_call(**kwargs):
	try:
		...
		finergy.db.rollback()
		finergy.log_error(title=_("Error in Exotel incoming call"))
		finergy.db.commit()
...
def get_call_log(call_payload):
	...
	if finergy.db.exists("Call Log", call_log_id):
		return finergy.get_doc("Call Log", call_log_id)


def create_call_log(call_payload):
	call_log = finergy.new_doc("Call Log")
...
def get_exotel_settings():
	return finergy.get_single("Exotel Settings")
