...
def get_product_filter_data(query_args=None):
	...
	query_args = finergy._dict(query_args)
	if query_args:
	...
	try:
		...
		finergy.log_error(traceback, finergy._("Product Engine Error"))
...
def get_guest_redirect_on_action():
	return finergy.db.get_single_value("E Commerce Settings", "redirect_on_action")
