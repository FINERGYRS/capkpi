...
def get_item_codes_by_attributes(attribute_filters, template_item_code=None):
	...
	for attribute, values in attribute_filters.items():
		...
		item_codes = set([r[0] for r in finergy.db.sql(query, query_values)])  # nosemgrep
...
def get_attributes_and_values(item_code):
	...
	item_attribute_values = finergy.db.get_all(
		"Item Attribute Value", ["parent", "attribute_value", "idx"], order_by="parent asc, idx asc"
	)
	ordered_attribute_value_map = finergy._dict()
...
def get_next_attribute_and_values(item_code, selected_attributes):
	...
	"""
	selected_attributes = finergy.parse_json(selected_attributes)
	...
	valid_options_for_attributes = finergy._dict()
