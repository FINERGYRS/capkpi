...
# Embedded file name: /Users/anuragmishra/finergy-develop/apps/capkpi/capkpi/buying/report/subcontracted_raw_materials_to_be_transferred/test_subcontracted_raw_materials_to_be_transferred.py
...
from capkpi.buying.report.subcontracted_raw_materials_to_be_transferred.subcontracted_raw_materials_to_be_transferred import (
	execute,
)
...
class TestSubcontractedItemToBeTransferred(FinergyTestCase):
			...
			filters=finergy._dict(
				{
					...
					"from_date": finergy.utils.get_datetime(
						finergy.utils.add_to_date(sco.transaction_date, days=-10)
					),
					"to_date": finergy.utils.get_datetime(finergy.utils.add_to_date(sco.transaction_date, days=10)),
				}
			)
		)
		sco.reload()
