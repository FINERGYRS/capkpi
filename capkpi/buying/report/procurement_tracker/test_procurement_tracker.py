...
from capkpi.buying.report.procurement_tracker.procurement_tracker import execute
...
class TestProcurementTracker(FinergyTestCase):
	...
	def generate_expected_data(self):
		if not finergy.db.exists("Company", "_Test Procurement Company"):
			finergy.get_doc(
				dict(
					doctype="Company",
