...
finergy.query_reports["Purchase Analytics"] = {
	"filters": [
		{
			fieldname: "tree_type",
			label: __("Tree Type"),
		...
		return Object.assign(options, {
			...
			events: {
				onCheckRow: function (data) {
					...
					const tree_type = finergy.query_report.filters[0].value;
					...
					const new_options = Object.assign({}, finergy.query_report.chart_options, {data: new_data});
					finergy.query_report.render_chart(new_options);
