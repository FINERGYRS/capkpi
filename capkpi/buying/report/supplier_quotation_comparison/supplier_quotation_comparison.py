...
def get_data(filters, conditions):
	supplier_quotation_data = finergy.db.sql(
		"""
		SELECT
...
def prepare_data(supplier_quotation_data, filters):
	...
	company_currency = finergy.db.get_default("currency")
	...
	for data in supplier_quotation_data:
		...
		supplier_currency = finergy.db.get_value(
...
def prepare_chart_data(suppliers, qty_list, supplier_qty_price_map):
	...
	dataset = []
	currency_symbol = finergy.db.get_value("Currency", finergy.db.get_default("currency"), "symbol")
	for qty in qty_list:
		datapoints = {
