...
from capkpi.buying.doctype.supplier_scorecard_variable.supplier_scorecard_variable import (
	VariablePathNotFound,
)


class TestSupplierScorecardVariable(FinergyTestCase):
	def test_variable_exist(self):
		for d in test_existing_variables:
			my_doc = finergy.get_doc("Supplier Scorecard Variable", d.get("name"))
