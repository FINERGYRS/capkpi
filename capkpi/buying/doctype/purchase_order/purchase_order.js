	...
	get_materials_from_supplier: function(frm) {
		...
		if (po_details && po_details.length) {
			frm.add_custom_button(__('Return of Components'), () => {
				frm.call({
					method: 'capkpi.buying.doctype.purchase_order.purchase_order.get_materials_from_supplier',
					freeze: true,
...
capkpi.buying.PurchaseOrderController = capkpi.buying.BuyingController.extend({
	setup: function() {
	...
	_make_rm_stock_entry: function(rm_items) {
		finergy.call({
			method:"capkpi.buying.doctype.purchase_order.purchase_order.make_rm_stock_entry",
			args: {
...
$.extend(cur_frm.cscript, new capkpi.buying.PurchaseOrderController({frm: cur_frm}));
