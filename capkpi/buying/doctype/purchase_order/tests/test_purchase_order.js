...
QUnit.test("test: purchase order", function(assert) {
	...
	finergy.run_serially([
		...
		() => {
			...
			assert.ok(cur_frm.doc.schedule_date == finergy.datetime.add_days(finergy.datetime.now_date(), 1), "Schedule Date correct");
			...
			assert.ok(cur_frm.doc.items[0].schedule_date == finergy.datetime.add_days(finergy.datetime.now_date(), 2), "Schedule Date correct");
