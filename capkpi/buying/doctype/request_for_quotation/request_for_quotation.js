...
capkpi.buying.RequestforQuotationController = capkpi.buying.BuyingController.extend({
	refresh: function() {
		var me = this;
		this._super();
...
$.extend(cur_frm.cscript, new capkpi.buying.RequestforQuotationController({frm: cur_frm}));
