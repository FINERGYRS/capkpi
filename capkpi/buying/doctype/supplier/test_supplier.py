...
from capkpi.exceptions import PartyDisabled

test_dependencies = ["Payment Term", "Payment Terms Template"]
test_records = finergy.get_test_records("Supplier")

from finergy.tests.utils import FinergyTestCase


class TestSupplier(FinergyTestCase):
	def test_get_supplier_group_details(self):
		doc = finergy.new_doc("Supplier Group")
		...
		doc.save()
		s_doc = finergy.new_doc("Supplier")
	...
	def test_supplier_default_payment_terms(self):
		...
		finergy.db.set_value("Supplier", "_Test Supplier With Template 1", "payment_terms", "")
		...
		finergy.db.set_value("Supplier Group", "_Test Supplier Group", "payment_terms", "")
		finergy.db.set_value("Supplier", "_Test Supplier", "payment_terms", "")
	...
	def test_supplier_disabled(self):
		...
		finergy.db.set_value("Supplier", "_Test Supplier", "disabled", 1)
		...
		finergy.db.set_value("Supplier", "_Test Supplier", "disabled", 0)

		po.save()

	def test_supplier_country(self):
		# Test that country field exists in Supplier DocType
		supplier = finergy.get_doc("Supplier", "_Test Supplier with Country")
...
def create_supplier(**args):
	...
	if finergy.db.exists("Supplier", args.supplier_name):
		return finergy.get_doc("Supplier", args.supplier_name)
