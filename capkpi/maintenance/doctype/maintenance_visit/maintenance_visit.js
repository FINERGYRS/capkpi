...
capkpi.maintenance.MaintenanceVisit = class MaintenanceVisit extends finergy.ui.form.Controller {
	refresh() {
...
extend_cscript(cur_frm.cscript, new capkpi.maintenance.MaintenanceVisit({frm: cur_frm}));
