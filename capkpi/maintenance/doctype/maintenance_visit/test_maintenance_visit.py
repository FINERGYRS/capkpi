...
import finergy
from finergy.utils.data import today

# test_records = finergy.get_test_records('Maintenance Visit')
...
def make_maintenance_visit():
	mv = finergy.new_doc("Maintenance Visit")
...
def make_sales_person(name):
	sales_person = finergy.get_doc({"doctype": "Sales Person", "sales_person_name": name})
