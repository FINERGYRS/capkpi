...
def execute(filters=None):
	...
	if finergy.db.has_column("Employee", "ifsc_code"):
		columns.append(
	...
	for salary in salary_slips:
		if (
			...
			row = {
				...
				"payment_date": finergy.utils.formatdate(salary.modified.strftime("%Y-%m-%d")),
				...
				"currency": finergy.get_cached_value("Company", filters.company, "default_currency"),
