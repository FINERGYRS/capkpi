...
class TestEmployeeTaxExemptionProofSubmission(FinergyTestCase):
	def setUp(self):
		make_employee("employee@proofsubmission.com", company="_Test Company")
		create_payroll_period(company="_Test Company")
		create_exemption_category()
		finergy.db.delete("Employee Tax Exemption Proof Submission")
		finergy.db.delete("Salary Structure Assignment")

	def test_exemption_amount_lesser_than_category_max(self):
		proof = finergy.get_doc(
			{
				"doctype": "Employee Tax Exemption Proof Submission",
				"employee": finergy.get_value("Employee", {"user_id": "employee@proofsubmission.com"}, "name"),
		...
		self.assertRaises(finergy.ValidationError, proof.save)
		proof = finergy.get_doc(
			{
				"doctype": "Employee Tax Exemption Proof Submission",
				"payroll_period": "Test Payroll Period",
	...
	def test_india_hra_exemption(self):
		...
		payroll_period = finergy.db.get_value(
