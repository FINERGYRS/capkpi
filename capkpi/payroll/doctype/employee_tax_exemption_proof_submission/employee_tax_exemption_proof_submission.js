...
finergy.ui.form.on('Employee Tax Exemption Proof Submission', {
	setup: function(frm) {
		...
		if(frm.doc.docstatus === 0) {
			...
			frm.add_custom_button(__('Get Details From Declaration'), function() {
				capkpi.utils.map_current_doc({
					method: "capkpi.payroll.doctype.employee_tax_exemption_declaration.employee_tax_exemption_declaration.make_proof_submission",
