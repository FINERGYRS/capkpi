...
from finergy.utils import add_days, date_diff, get_year_ending, get_year_start, getdate
...
from capkpi.hr.doctype.leave_application.test_leave_application import get_first_sunday
...
class TestEmployeeBenefitApplication(FinergyTestCase):
	def setUp(self):
		date = getdate()
...
def make_employee_benefit_application(employee, payroll_period, date):
	finergy.db.delete("Employee Benefit Application")
