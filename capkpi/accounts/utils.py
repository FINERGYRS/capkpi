...
def get_fiscal_years(
	...
	if not fiscal_years:
		...
		cond = ""
		if fiscal_year:
			cond += " and fy.name = {0}".format(finergy.db.escape(fiscal_year))
		if company:
			cond += """
...
def get_outstanding_invoices(party_type, party, account, condition=None, filters=None):
	...
	payment_entries = finergy.db.sql(
		"""
