...
from capkpi.accounts.report.general_ledger.general_ledger import execute


class TestGeneralLedger(FinergyTestCase):
	def test_foreign_account_balance_after_exchange_rate_revaluation(self):
		...
		revaluation = finergy.new_doc("Exchange Rate Revaluation")
		...
		revaluation_jv = finergy.get_doc(revaluation_jv)
