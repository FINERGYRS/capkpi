...
class TestTaxDetail(unittest.TestCase):
	...
	def load_defcols(self):
		self.company = finergy.get_doc("Company", "_T")
		custom_report = finergy.get_doc("Report", "Tax Detail")
	...
	def rm_testdocs(self):
		...
		from capkpi.setup.doctype.company.company import create_transaction_deletion_request
