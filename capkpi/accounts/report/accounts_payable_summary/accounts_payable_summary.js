...
finergy.query_reports["Accounts Payable Summary"] = {
	"filters": [
		{
			"fieldname":"company",
			"label": __("Company"),
	...
	onload: function(report) {
		report.page.add_inner_button(__("Accounts Payable"), function() {
			...
			finergy.set_route('query-report', 'Accounts Payable', {company: filters.company});
		});
	}
}

capkpi.utils.add_dimensions('Accounts Payable Summary', 9);
