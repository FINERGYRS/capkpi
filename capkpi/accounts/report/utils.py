import finergy
from finergy.utils import flt, formatdate, get_datetime_str

from capkpi import get_company_currency, get_default_company
from capkpi.accounts.doctype.fiscal_year.fiscal_year import get_from_and_to_date
...
def get_invoiced_item_gross_margin(
	...
	from capkpi.accounts.report.gross_profit.gross_profit import GrossProfitGenerator

	sales_invoice = sales_invoice or finergy.form_dict.get("sales_invoice")
	item_code = item_code or finergy.form_dict.get("item_code")
	company = company or finergy.get_cached_value("Sales Invoice", sales_invoice, "company")
