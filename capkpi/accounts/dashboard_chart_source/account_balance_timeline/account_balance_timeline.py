...
from finergy.utils import add_to_date, formatdate, get_link_to_form, getdate, nowdate
from finergy.utils.dashboard import cache_source
from finergy.utils.dateutils import get_from_date_from_timespan, get_period_ending
...
def get(
	...
	if not finergy.db.exists("Account", account) and chart_name:
		finergy.throw(
...
def build_result(account, dates, gl_entries):
	...
	root_type = finergy.db.get_value("Account", account, "root_type")
