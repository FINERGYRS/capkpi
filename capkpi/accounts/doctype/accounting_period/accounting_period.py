...
class AccountingPeriod(Document):
	...
	def autoname(self):
		company_abbr = finergy.get_cached_value("Company", self.company, "abbr")
		self.name = " - ".join([self.period_name, company_abbr])

	def validate_overlap(self):
		existing_accounting_period = finergy.db.sql(
	...
	def get_doctypes_for_closing(self):
		...
		doctypes = finergy.get_hooks("period_closing_doctypes")
