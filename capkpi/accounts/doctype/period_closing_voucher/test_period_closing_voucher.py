...
from capkpi.accounts.doctype.finance_book.test_finance_book import create_finance_book
...
from capkpi.accounts.utils import get_fiscal_year, now


class TestPeriodClosingVoucher(unittest.TestCase):
	def test_closing_entry(self):
		finergy.db.sql("delete from `tabGL Entry` where company='Test PCV Company'")
...
test_records = finergy.get_test_records("Period Closing Voucher")
