...
import finergy
from finergy import ValidationError, _, scrub, throw
...
from capkpi.hr.doctype.expense_claim.expense_claim import (
		...
		if self.payment_type in ("Pay") and self.party:
			for d in self.get("references"):
				if d.reference_doctype == "Expense Claim" and d.reference_name:
					doc = finergy.get_doc("Expense Claim", d.reference_name)
					if self.docstatus == 2:
		...
		if self.payment_type == "Receive" and self.party_type == "Donor" and self.party:
			for d in self.get("references"):
				if d.reference_doctype == "Donation" and d.reference_name:
					...
					finergy.db.set_value("Donation", d.reference_name, "paid", is_paid)
