...
class CurrencyExchangeSettings(Document):
	def validate(self):
		...
		if finergy.flags.in_test or finergy.flags.in_install or finergy.flags.in_setup_wizard:
			return
	...
	def validate_result(self, response, value):
		try:
			...
			finergy.throw(_("Invalid result key. Response:") + " " + response.text)
		if not isinstance(value, (int, float)):
			finergy.throw(_("Returned exchange rate is neither integer not float."))
