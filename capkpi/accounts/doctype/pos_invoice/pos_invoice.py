...
class POSInvoice(SalesInvoice):
	...
	def validate_stock_availablility(self):
		...
		if self.docstatus == 0 and not finergy.db.get_value(
			"POS Profile", self.pos_profile, "validate_stock_on_save"
		):
			return

		allow_negative_stock = finergy.db.get_single_value("Stock Settings", "allow_negative_stock")
	...
	def get_existing_payment_request(self, pay):
		...
		pr = finergy.db.exists(args)
		if pr:
			return finergy.get_doc("Payment Request", pr[0][0])
