...
from finergy.tests.utils import change_settings
...
from capkpi.accounts.doctype.purchase_invoice.purchase_invoice import WarehouseMissingError
...
class TestSalesInvoice(unittest.TestCase):
	...
	def test_outstanding_on_cost_center_allocation(self):
		...
		from capkpi.accounts.doctype.cost_center_allocation.test_cost_center_allocation import (
	...
	def test_inter_company_transaction_without_default_warehouse(self):
		...
		# setup
		old_negative_stock = finergy.db.get_single_value("Stock Settings", "allow_negative_stock")
		finergy.db.set_value("Stock Settings", None, "allow_negative_stock", 1)

		old_perpetual_inventory = capkpi.is_perpetual_inventory_enabled("_Test Company 1")
		finergy.local.enable_perpetual_inventory["_Test Company 1"] = 1
		...
		if not finergy.db.exists("Customer", "_Test Internal Customer"):
		...
		# tear down
		finergy.local.enable_perpetual_inventory["_Test Company 1"] = old_perpetual_inventory
		finergy.db.set_value("Stock Settings", None, "allow_negative_stock", old_negative_stock)
	...
	def test_sales_invoice_with_disabled_account(self):
		try:
			...
			account = finergy.get_doc("Account", account_name)
			account.disabled = 1
			account.save()
