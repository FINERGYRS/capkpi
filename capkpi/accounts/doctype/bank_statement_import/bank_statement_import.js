...
finergy.ui.form.on("Bank Statement Import", {
	setup(frm) {
		finergy.realtime.on("data_import_refresh", ({ data_import }) => {
			frm.import_in_progress = false;
			if (data_import !== frm.doc.name) return;
			finergy.model.clear_doc("Bank Statement Import", frm.doc.name);
			finergy.model
	...
	// method: 'finergy.core.doctype.data_import.data_import.get_preview_from_template',
