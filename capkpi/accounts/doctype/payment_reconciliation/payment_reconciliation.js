...
capkpi.accounts.PaymentReconciliationController = finergy.ui.form.Controller.extend({
	onload: function() {
...
$.extend(cur_frm.cscript, new capkpi.accounts.PaymentReconciliationController({frm: cur_frm}));
