...
from capkpi.accounts.doctype.share_transfer.share_transfer import ShareDontExists
...
class TestShareTransfer(unittest.TestCase):
	def setUp(self):
		finergy.db.sql("delete from `tabShare Transfer`")
		finergy.db.sql("delete from `tabShare Balance`")
		share_transfers = [
			{
