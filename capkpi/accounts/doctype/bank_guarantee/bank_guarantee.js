...
finergy.ui.form.on('Bank Guarantee', {
	setup: function(frm) {
	...
	reference_docname: function(frm) {
		if (frm.doc.reference_docname && frm.doc.reference_doctype) {
			...
			finergy.call({
				method: "capkpi.accounts.doctype.bank_guarantee.bank_guarantee.get_vouchar_detials",
				args: {
	...
	start_date: function(frm) {
		var end_date = finergy.datetime.add_days(cur_frm.doc.start_date, cur_frm.doc.validity - 1);
