...
finergy.ui.form.on('Exchange Rate Revaluation', {
	setup: function(frm) {
...
finergy.ui.form.on("Exchange Rate Revaluation Account", {
...
var get_account_details = function(frm, cdt, cdn) {
	...
	if(!frm.doc.company || !frm.doc.posting_date) {
		finergy.throw(__("Please select Company and Posting Date to getting entries"));
	}
	finergy.call({
		method: "capkpi.accounts.doctype.exchange_rate_revaluation.exchange_rate_revaluation.get_account_details",
		args:{
			account: row.account,
