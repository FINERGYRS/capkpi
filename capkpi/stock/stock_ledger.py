...
from finergy.utils import cint, cstr, flt, get_datetime, get_link_to_form, getdate, now, nowdate
...
class update_entries_after(object):
	...
	def __init__(
		...
		self.allow_negative_stock = allow_negative_stock or cint(
			finergy.db.get_single_value("Stock Settings", "allow_negative_stock")
		)
	...
	def get_incoming_outgoing_rate_from_transaction(self, sle):
		...
		# Sales and Purchase Return
			...
			if finergy.get_cached_value(sle.voucher_type, sle.voucher_no, "is_return"):
				...
				and finergy.get_cached_value(sle.voucher_type, sle.voucher_no, "is_internal_supplier")
			):
				sle_details = finergy.db.get_value(
					"Stock Ledger Entry",
					{
	...
	def update_rate_on_purchase_receipt(self, sle, outgoing_rate):
		...
		if finergy.get_cached_value(sle.voucher_type, sle.voucher_no, "is_subcontracted") == "Yes":
