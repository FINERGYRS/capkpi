...
class TestStockUtilities(FinergyTestCase, StockTestMixin):
	def test_barcode_scanning(self):
		...
		batch = finergy.get_doc(doctype="Batch", item=batch_item.name).insert()
		...
		serial = finergy.get_doc(
			doctype="Serial No", item_code=serial_item.name, serial_no=finergy.generate_hash()
		).insert()
