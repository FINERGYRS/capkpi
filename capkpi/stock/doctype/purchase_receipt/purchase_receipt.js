...
capkpi.stock.PurchaseReceiptController = capkpi.buying.BuyingController.extend({
	setup: function(doc) {
...
$.extend(cur_frm.cscript, new capkpi.stock.PurchaseReceiptController({frm: cur_frm}));
