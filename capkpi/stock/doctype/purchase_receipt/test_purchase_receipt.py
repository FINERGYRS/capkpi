...
class TestPurchaseReceipt(FinergyTestCase):
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		from capkpi.accounts.doctype.purchase_invoice.purchase_invoice import (
		...
		from capkpi.accounts.party import add_party_account
		...
		exchange_gain_loss_account = finergy.db.get_value(
			"Company", pr.company, "exchange_gain_loss_account"
		)

		# fetching the latest GL Entry with exchange gain and loss account account
		amount = finergy.db.get_value(
