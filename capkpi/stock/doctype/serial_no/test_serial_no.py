...
test_records = finergy.get_test_records("Serial No")


class TestSerialNo(FinergyTestCase):
	def tearDown(self):
		finergy.db.rollback()

	def test_cannot_create_direct(self):
		finergy.delete_doc_if_exists("Serial No", "_TCSER0001")
	...
	def test_inter_company_transfer(self):
		...
		serial_no = finergy.get_doc("Serial No", serial_nos[0])
	...
	def test_inter_company_transfer_intermediate_cancellation(self):
		...
		sn_doc = finergy.get_doc("Serial No", serial_nos[0])
		...
		self.assertRaises(finergy.ValidationError, se.cancel)
		...
		self.assertRaises(finergy.ValidationError, dn.cancel)
		...
		self.assertRaises(finergy.ValidationError, se.cancel)
		self.assertRaises(finergy.ValidationError, dn.cancel)
		self.assertRaises(finergy.ValidationError, pr.cancel)
	...
	def test_auto_fetch(self):
		...
		# expiry date
		finergy.db.set_value("Batch", batch1, "expiry_date", "1980-01-01")
