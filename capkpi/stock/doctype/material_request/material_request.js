...
capkpi.buying.MaterialRequestController = capkpi.buying.BuyingController.extend({
	tc_name: function() {
		this.get_terms();
	},
...
$.extend(cur_frm.cscript, new capkpi.buying.MaterialRequestController({frm: cur_frm}));
