	...
	finergy.run_serially([
		() => {
			return finergy.tests.make('Stock Entry', [
				...
				{from_warehouse:'Work In Progress - '+finergy.get_abbr(finergy.defaults.get_default('Company'))},
				{to_warehouse:'Finished Goods - '+finergy.get_abbr(finergy.defaults.get_default('Company'))},
				{items: [
					[
