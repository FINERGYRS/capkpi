...
from capkpi.stock.doctype.item_price.item_price import ItemPriceDuplicateItem
from capkpi.stock.get_item_details import get_price_list_rate_for, process_args


class TestItemPrice(FinergyTestCase):
	def setUp(self):
		super().setUp()
	...
	def test_duplicate_item(self):
		doc = finergy.copy_doc(test_records[0])
		self.assertRaises(ItemPriceDuplicateItem, doc.save)

	def test_addition_of_new_fields(self):
		# Based on https://github.com/finergyrs/capkpi/issues/8456
	...
	def test_price_in_a_qty(self):
		...
		doc = finergy.copy_doc(test_records[2])
	...
	def test_prices_at_invalid_date(self):
		...
		doc = finergy.copy_doc(test_records[3])
	...
	def test_prices_outside_of_date(self):
		...
		doc = finergy.copy_doc(test_records[4])
...
test_records = finergy.get_test_records("Item Price")
