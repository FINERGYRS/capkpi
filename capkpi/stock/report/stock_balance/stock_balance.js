...
finergy.query_reports["Stock Balance"] = {
	"filters": [
		{
			"fieldname": "company",
			"label": __("Company"),
		...
		},
		{
			...
			"options": "Warehouse",
			get_query: () => {
				let warehouse_type = finergy.query_report.get_filter_value("warehouse_type");
...
capkpi.utils.add_inventory_dimensions('Stock Balance', 8);