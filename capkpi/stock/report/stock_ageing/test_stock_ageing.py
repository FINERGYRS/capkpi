...
from capkpi.stock.report.stock_ageing.stock_ageing import FIFOSlots, format_report_data


class TestStockAgeing(FinergyTestCase):
	def setUp(self) -> None:
