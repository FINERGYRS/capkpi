...
def execute(filters=None):
	if not filters:
		filters = {}
	float_precision = finergy.db.get_default("float_precision")
	...
	if diff <= 0:
		finergy.throw(_("'From Date' must be after 'To Date'"))
...
def get_condition(filters):
	...
	if filters.get("from_date") and filters.get("to_date"):
		...
		finergy.throw(_("From and To dates required"))
	return conditions
