...
def get_incorrect_serial_nos(serial_nos_data):
	...
	total_value = finergy._dict(
		{"qty": 0, "valuation_rate": 0, "serial_no": finergy.bold(_("Balance"))}
	)

	for serial_no, data in serial_nos_data.items():
		total_dict = finergy._dict({"qty": 0, "valuation_rate": 0, "serial_no": finergy.bold(_("Total"))})
